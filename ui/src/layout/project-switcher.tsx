...
export function ProjectSwitcher({ className }: Props) {
  ...
  const groups = [
    ...
    },
    {
      ...
      organizations: organizations
        .filter((organization) => organization.id !== user.selectedOrganization.id)
      ...
      <PopoverTrigger asChild>
        ...
        >
          ...
          <div className="flex flex-col gap-[3px] items-start">
            <p className=" leading-none text-xs">{user.selectedOrganization.name}</p>
            <p className="text-[10px] leading-none">{user.selectedProject.name}</p>
          </div>
                ...
                {group.organizations.map((organization) => (
                  ...
                  >
                    ...
                    <CheckIcon
                      className={cn(
                        "ml-auto h-4 w-4",
                        user.selectedOrganization.id === organization.value ? "opacity-100" : "opacity-0"
                      )}
                    />
                  </CommandItem>
                ))}
                        ...
                        return (
                          ...
                          >
                            ...
                            <CheckIcon
                              className={cn(
                                "ml-auto h-4 w-4",
                                user.selectedProject.id === project.id ? "opacity-100" : "opacity-0"
                              )}
                            />
                          </CommandItem>
                        );
      ...
      <DialogContent>
        ...
        <Form {...newProjectForm}>
          <form onSubmit={newProjectForm.handleSubmit(onProjectSubmit)}>
            ...
            <DialogFooter>
              <Button variant="ghost" disabled={isLoading} onClick={() => setShowNewEnvironmentDialog(false)}>
                Cancel
              </Button>
