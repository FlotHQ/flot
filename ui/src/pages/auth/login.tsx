		...
		<div className="flex   shrink-0 justify-center h-full ">
			<div className="flex-col  flex items-center   shrink-0 mt-[250px] ">
				...
				<div className=" space-y-2 mt-8 flex flex-col items-center">
					...
					<a
						href={`${import.meta.env.DEV ? "http://localhost:3000" : "https://api.flot.so"}/api/oauth/login/google`}
					>
						<Button
							className="space-x-3"
							variant="outline"
					...
					<a
						href={`${import.meta.env.DEV ? "http://localhost:3000" : "https://api.flot.so"}/api/oauth/login/github`}
					>
						<Button
							className="space-x-3"
							variant="outline"
